class lvl3GameScene3 extends Phaser.Scene {
	constructor() {
		super({ key: 'lvl3GameScene3' });
    this.heights = [8, null, 7, 6, null, 5, 6, null, 4.8];
    this.weather = 'night';
	}
  ...
  create() {
    ...
    gameState.player = this.physics.add.sprite(100, 1000, 'gwen-anim').setScale(0.4).setGravityY(200);
    ...
    this.physics.add.overlap(gameState.player, gameState.goal, function() {
      this.cameras.main.fade(800, 0, 0, 0, false, function(camera, progress) {
        if (progress > .9) {
          ...
          this.scene.stop(); 
          this.scene.start('lvl4GameStart');
        }
      });
    }, null, this);
